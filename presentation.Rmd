...
## Simulation: Single Imputation - Reg
...
x_{i2}* = \begin{cases}
x_{i2} & \text{if } x_{i2} \text{ is observed}\\
\widehat{x_{i2}} & \text{otherwise}\\
\end{cases}
\end{equation}

Where $\widehat{x_{i2}}$ is the predicted value for $x_{i2}$ from regressing $X2$ on $X1$.
...
- UMLE and CBE from @SunBaoluo2017OIPW
